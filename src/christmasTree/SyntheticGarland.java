...
public class SyntheticGarland extends Garland {
    ...
    public SyntheticGarland(ChrismasTree treeDecorator) {
        ...
        setDescription(treeDecorator.getDescription()+" SyntheticGarlandDecorator: "
                +"Garland");
        setPrice(treeDecorator.getPrice()+10.99);
        setLength(15);
        setPaillette(getPaillette()==null?""+" SyntheticGarlandPaillette: "
                +paillette:getPaillette()+" SyntheticGarlandPaillette:: "+"Square");
    }

    public SyntheticGarland(String paillette, String color, String description, 
            double price, double length, ChrismasTree treeDecorator) {
        super(treeDecorator);
        setColor(treeDecorator.getColor()==null?"":treeDecorator.getColor()+
        ...
        setLength(length);
        this.paillette = getPaillette()==null?""+" SyntheticGarlandPaillette: "
                +paillette:getPaillette()+" SyntheticGarlandPaillette:: "+paillette;
    }
